...
export const CORE_ASSETS_DIR = "src/core/assets";
export const GAME_ASSETS_DIR = "src/game/assets";

export const BASIC_CHARS = {
  kigou:
    "!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~、。〃々〆〇〈〉《》「」『』【】〒〔〕〜〝〟゛゜ゝゞ・ーヽヾ",
  english: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz",
  kana: "ぁあぃいぅうぇえぉおかがきぎくぐけげこごさざしじすずせぜそぞただちぢっつづてでとどなにぬねのはばぱひびぴふぶぷへべぺほぼぽまみむめもゃやゅゆょよらりるれろゎわをんァアィイゥウェエォオカガキギクグケゲコゴサザシジスズセゼソゾタダチヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポマミムメモャヤュユョヨラリルレロヮワヲンヴゐゑヰヱヵヶ",
  kanji: [
    ...
    "誌雌摯賜諮示字寺次耳自似児事侍治持時滋慈辞磁餌璽鹿式識軸七叱失室疾執湿嫉漆質実芝写社車舎者射捨赦斜煮",
